...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    related: ['hex-to-text', 'base64-encoder', 'subnet-calculator', 'unicode-converter'],
    component: 'TextToHex',
    icon: 'binary',
    serverProcessing: false,
    addedAt: LAUNCH_DATE,
  ...
  },
  {
    ...
    related: ['password-generator', 'uuid-generator', 'lorem-ipsum-generator', 'nano-id-generator'],
  ...
  // ─── Date & Time ────────────────────────────────────────────────────────
  {
    ...
    order: 1,
    description:
      'The live Unix epoch plus conversion both ways, in seconds or milliseconds, UTC and local.',
    seoTitle: 'Unix Timestamp Converter — Epoch Time Now',
    seoDescription:
      'The current Unix epoch updating live, plus conversion both ways between timestamps and readable dates. Auto-detects seconds versus milliseconds and shows UTC and local time.',
    keywords: [
    ...
    related: ['iso-date-converter', 'timezone-converter', 'date-difference-calculator', 'cron-expression-parser'],
  ...
  },
  {
    ...
    related: ['unix-timestamp-converter', 'timezone-converter', 'iso-date-converter'],
  ...
  },
  {
    ...
    related: ['unix-timestamp-converter', 'timezone-converter', 'date-difference-calculator'],
  ...
  },
  {
    ...
    related: ['unix-timestamp-converter', 'iso-date-converter', 'cron-expression-generator'],
  ...
  },
  {
    ...
    related: ['cron-expression-parser', 'unix-timestamp-converter', 'timezone-converter', 'iso-date-converter'],
  ...
  // ─── Text Tools ─────────────────────────────────────────────────────────
  {
    ...
    related: ['character-counter', 'text-case-converter', 'lorem-ipsum-generator', 'sort-lines'],
  ...
  },
  {
    ...
    related: ['user-agent-parser', 'what-is-my-ip', 'url-decoder', 'jwt-decoder'],
  ...
  },
  {
    ...
    related: ['what-is-my-ip', 'http-status-codes', 'regex-tester', 'url-decoder'],
